	...
	return (
		<>
			<Tabs id="controlled" activeKey={key} onSelect={(k) => setKey(k)} className="mb-3 border-0">
				<Tab eventKey="home" title="Description" className="pb-5 ps-0 border-0 rounded-0 font-lato">
				...
				<Tab eventKey="spacification" title="Spacification" className="pb-5 font-lato">
					<div className="detail-table border-top border-warning pt-3">
						<table class="table border-gray font-lato ">
							<thead>
								<tr>
									<th scope="col">1</th>
					...
					<div className="border-top border-warning  pt-3">
						...
						<div className="row">
								<div className="col-lg-4">
									...
									<div className=" mt-3">
										<div class="mb-3">
											<label for="" class="form-label font-16">
												Name *
											</label>
											<input type="text" class="form-control rounded-1" id="" placeholder="Enter Your Name" />
										</div>
										<div class="mb-3">
											<label for="" class="form-label font-16">
												Email *
											</label>
											<input type="email" class="form-control rounded-1" id="" placeholder="Enter Your Mail" />
										</div>
								...
								<div className="col-lg-8">
									<div className=''>
										...
										<StarRating/>
										<label for="" class="form-label font-16">Your comment *</label>
										<div class="form-floating">
											<textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style={{height: "100px"}}></textarea>
											<label for="floatingTextarea2">Comments</label>
										</div>
										<button type="submit" class="btn btn-primary submit-btn rounded-1 mt-3">
											Submit
										</button>
									</div>
								</div>
